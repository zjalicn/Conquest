...
multiplayclick = image.load("images/buttons/button2click.png")
statsclick = image.load("images/buttons/button3click.png")
optionsclick = image.load("images/buttons/button4click.png")
...
multiplayRect = Rect(500,310,200,50)
statsRect = Rect(500,370,200,50)
optionsRect = Rect(500,430,200,50)
...
def updateStats(): #doesnt work yet
    global stats, update
    for stat in stats:
...
while running:
            ...
            if evt.button == 1:
                ...
                if menu == "home":
                    if playRect.collidepoint(mx,my):
                        ...
                        menu = "difficulty"
                        stats[0] += 1
                    if multiplayRect.collidepoint(mx,my):
    ...
    if menu == "home":
        ...
        if mb[0] == 1:
            ...
            if multiplayRect.collidepoint(mx,my):
                screen.blit(multiplayclick,(500,310))
            if statsRect.collidepoint(mx,my):
                screen.blit(statsclick,(500,370))
            if optionsRect.collidepoint(mx,my):
                screen.blit(optionsclick,(500,430))
                
    if menu == "stats":
        print "STATS"

    if menu == "difficulty":
        #add difficulty screen stuff
        menu = "battle"
